...
from handlers.paper_handler import paper_download_callback, paper_paginate_callback, paper_search_command, sh_download_callback
...
def main() -> None:
    ...
    application.add_handler(CallbackQueryHandler(sh_download_callback, pattern=r"^sh_pdf\|"))
