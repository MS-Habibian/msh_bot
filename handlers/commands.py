...
HELP_TEXTS = {
    ...
    "help_pin": (
        "📌 *راهنمای پینترست*\n\n"
        "با این قابلیت می‌توانید در پینترست جستجو کنید و تصاویر یا ویدیوها را با کیفیت اصلی دانلود کنید.\n\n"
    ...
    "help_google": (
        ...
        "🔸 *دستور:* `/dlp <لینک وبسایت موردنظر>`\n"
        "🔹 *مثال:* `/dlp www.wikipedia.com`"
    ),
    "help_image": (
